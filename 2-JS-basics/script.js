...
let markIsHigher = johnBMI < markBMI;
console.log(johnBMI, markBMI, markIsHigher)
...
if (johnAverageScore > mikeAverageScore && johnAverageScore > maryAverageScore) {
    console.log(`John's team wins with an average score of ${johnAverageScore}!`);
} else if (mikeAverageScore > johnAverageScore && mikeAverageScore > maryAverageScore) {
    console.log(`Mike's team wins with an average score of ${mikeAverageScore}!`);
} else if (maryAverageScore > johnAverageScore && maryAverageScore > mikeAverageScore) {
    console.log(`Mary's team wins with an average score of ${maryAverageScore}!`);
}
else {
...
var john = ['John', 'Smith', 1990, 'teacher', false, 'designer', 'blue'];

// continue stops and skips whatever code comes after to start the next iteration of the loop
for(i = 0; i < john.length; i++){
...
// small challenge: loop through the array backwards using a for loop
